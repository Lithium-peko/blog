...
func (s *Resource) GetTreeList(req req.PageQuery) []resp.ResourceVo {
	...
	// []resource -> []resourceVo
	return s.resource2ResourceVos(resources)
}
...
// 编辑资源的匿名访问, 关联更新 casbin_rule 中的数据
...
func (s *Resource) resource2ResourceVos(resources []model.Resource) []resp.ResourceVo {
...
// 存储每个节点对应的 [子资源列表] 的 map : key 为 resourceId, value 为其对应的 childrenList
